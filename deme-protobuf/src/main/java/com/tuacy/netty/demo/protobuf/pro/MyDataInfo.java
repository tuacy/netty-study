...
public final class MyDataInfo {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using com.tuacy.netty.demo.protobuf.pro.MyDataInfo.MyMessage.newBuilder()
      private Builder() {
  ...
  public interface StudentOrBuilder extends
    ...
    /**
     * <pre>
     * Student类中有一个属性，名字为id,类型为int32(protobuf类型) - &gt; 对应java int 1表示属性序号
     * </pre>
     *
  ...
  /**
   * <pre>
   * 会在外部类(StudentPOJO)生成一个内部类(Student)，他时真正发送的POJO对象
   * </pre>
   *
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using com.tuacy.netty.demo.protobuf.pro.MyDataInfo.Student.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using com.tuacy.netty.demo.protobuf.pro.MyDataInfo.Worker.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
